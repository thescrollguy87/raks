...
const summary = asyncHandler(async (req, res) => {
  ...
  const [qualificationExpiry, leaveBalance, dgcaCompliance, flightCoverage, rosterCoverage, staffWorkload] = await Promise.all([
  ...
  res.json({ qualificationExpiry, leaveBalance, dgcaCompliance, flightCoverage, rosterCoverage, staffWorkload });
});

module.exports = { qualificationExpiry, leaveBalance, rosterCoverage, flightCoverage, dgcaCompliance, staffWorkload, summary };
