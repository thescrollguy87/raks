...
router.get("/station/:stationId", requirePermission("tool", "read"), requireOwnStation("params"), ctrl.listForStation);
router.post("/", requirePermission("tool", "calibrate"), validate(createToolSchema), requireOwnStation("body"), ctrl.create);
