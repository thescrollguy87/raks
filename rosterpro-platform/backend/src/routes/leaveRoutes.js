...
const { requestLeaveSchema, decideLeaveSchema, leaveQuerySchema, teamCalendarQuerySchema } = require("../validators/leaveValidators");
...
router.get(
  "/team-calendar",
  requireAnyPermission(["leave", "approve"], ["leave", "approve_reports"]),
  validateQuery(teamCalendarQuerySchema),
  ctrl.teamCalendar
);
