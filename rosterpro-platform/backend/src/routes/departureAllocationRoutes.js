...
const { dayQuerySchema, monthQuerySchema, manualAssignSchema } = require("../validators/departureAllocationValidators");

const router = express.Router();
router.use(requireAuth);

router.get("/month-summary", requirePermission("roster", "read"), validateQuery(monthQuerySchema), requireOwnStation("query"), ctrl.getMonthSummary);
